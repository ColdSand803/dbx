export default {
  ...
  mongo: {
    ...
    nativeJsonHint: "Use MongoDB Extended JSON for BSON values such as $oid, $date, and $numberLong.",
    invalidNativeJson: "Native JSON is invalid: {error}",
    nativeDocumentRequired: "Native JSON must be a document object.",
